...
<FileZilla3>
    <Settings>
        ...
        <Setting name="fzsftp executable" type="string">&quot;D:\Users\chen hong qiang\Documents\Software\Other\ChqPortal-win32-x64\resources\app\node_modules\chqportal\soft\ftp\fzsftp.exe&quot;</Setting>
        ...
        <Setting name="Last Server Path" type="string"></Setting>
        ...
        <Setting name="Last automatic update check" type="string">2017-02-13 20:04:33</Setting>
        ...
        <Setting name="Greeting version" type="string">3.2.6.1</Setting>
        ...
        <Setting name="Last local directory" type="string">D:\Users\chen hong qiang\Documents\Temp\20170217\</Setting>
        <Setting name="Filelist directory sort" type="number">0</Setting>
        <Setting name="Queue successful autoclear" type="number">0</Setting>
        <Setting name="Queue column widths" type="string">1842 60 636 80 60 150</Setting>
        <Setting name="Local filelist colwidths" type="string">259 80 100 120</Setting>
        <Setting name="Remote filelist colwidths" type="string">1450 75 80 161 80 107</Setting>
        <Setting name="Window position and size" type="string">1 65 91 940 713 </Setting>
        <Setting name="Splitter positions (v2)" type="string">112 -202 319230769 100 106 500000000</Setting>
        <Setting name="Local filelist sortorder" type="string">1 0</Setting>
        ...
        <Setting name="Custom file associations" type="string">&#x0A;jsp &quot;C:\Program Files (x86)\IDM Computer Solutions\UltraEdit-32\uedit32.exe&quot;&#x0A;properties &quot;C:\Program Files (x86)\IDM Computer Solutions\UltraEdit-32\uedit32.exe&quot;&#x0A;conf &quot;C:\Program Files (x86)\IDM Computer Solutions\UltraEdit-32\uedit32.exe&quot;&#x0A;plist C:\windows\system32\NOTEPAD.EXE&#x0A;/ C:\windows\system32\NOTEPAD.EXE</Setting>
        <Setting name="Comparison mode" type="number">1</Setting>
        <Setting name="Comparison threshold" type="number">1</Setting>
        <Setting name="Site Manager position" type="string">0 356 281 551 383 </Setting>
        <Setting name="Theme icon size" type="string" />
        <Setting name="Timestamp in message log" type="number">0</Setting>
        <Setting name="Sitemanager last selected" type="string">0EST_UAT_SES/</Setting>
        ...
        <Setting name="Last connected site" type="string">0EST_UAT_CIN</Setting>
        ...
        <Setting name="Search window size" type="string">0 257 223 750 500 </Setting>
